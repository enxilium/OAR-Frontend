...
# Instead of "localhost:3000", use a valid domain or IP:
PUBLIC_HOSTNAME_WHITELIST.append("lvh.me:3000")
# Or, if your Next.js calls use 127.0.0.1:
PUBLIC_HOSTNAME_WHITELIST.append("127.0.0.1:3000")
